...
class DivisorDeTensãoFET(Frame):
	def __init__(self, raiz):
		Frame.__init__(self, raiz)
		Label(self, text="Iterative Transistor Calculater\nDivisor de Tensão FET").grid(row=0, column=0, columnspan=7)
		linha = 1
		...
		# Ordem Entradas
		self.t_entradas = ["R1", "R2", "Rd", "Rs", "Vp", "Vgs", "Yos", "Idss"]
		# Ordem Saidas
	...
	def calcularSaidas(self):
		...
		# Zi
		try:
			self.dados["Zi"]["val"] = paralelo(self.dados["R1"]["val"],self.dados["R2"]["val"])
