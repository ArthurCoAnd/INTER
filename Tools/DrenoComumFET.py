...
class DrenoComumFET(Frame):
	def __init__(self, raiz):
		...
		# Ordem Entradas
		self.t_entradas = ["Rg", "Rs", "Vp", "Vgs", "Yos", "Idss"]
		# Ordem Saidas
	...
	def calcularSaidas(self):
		...
		# Avnl
		try:
			self.dados["Avnl"]["val"] = (self.dados["gm"]["val"]*(paralelo(self.dados["Rs"]["val"],self.dados["rd"]["val"])))/(1+self.dados["gm"]["val"]*(paralelo(self.dados["Rs"]["val"],self.dados["rd"]["val"])))
		...
		# Zo
		try:
			self.dados["Zo"]["val"] = paralelo(self.dados["Rs"]["val"],paralelo(self.dados["rd"]["val"],1/self.dados["gm"]["val"]))
